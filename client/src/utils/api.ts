...
export const DEFAULT_EVENT: EventData = {
  ...
  brideFullName: 'Alex', brideRole: 'Putra dari', brideFather: 'Bpk. Ahmad', brideMother: 'Ibu Siti', bridePhoto: '/assets/images/couple-1.jpg', brideSocial: '',
  groomFullName: 'Jessica', groomRole: 'Putri dari', groomFather: 'Bpk. Budi', groomMother: 'Ibu Dewi', groomPhoto: '/assets/images/couple-2.jpg', groomSocial: '',
  ...
  venueName: 'Gedung Serbaguna Harmoni', venueAddress: 'Jl. Melati No. 12, Jakarta Pusat',
  akadDate: 'Sabtu, 12 Desember 2026', akadTime: '08:00 - 10:00 WIB',
  resepsiDate: 'Sabtu, 12 Desember 2026', resepsiTime: '11:00 - 17:00 WIB',
};
